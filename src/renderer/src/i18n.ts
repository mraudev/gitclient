...
const de = {
  ...
  changes: {
    ...
    summaryPlaceholder: 'Zusammenfassung (erste Zeile)',
    descriptionPlaceholder: 'Beschreibung (optional)',
    commitShortcut: 'Committen (Strg+Enter)',
...
const en: Messages = {
  ...
  changes: {
    ...
    summaryPlaceholder: 'Summary (first line)',
    descriptionPlaceholder: 'Description (optional)',
    commitShortcut: 'Commit (Ctrl+Enter)',
